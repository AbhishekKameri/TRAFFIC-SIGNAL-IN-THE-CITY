...
void start() {
    ...
    glColor3ub(0, 0, 0);
    c="-> Press 'd' = Switch to DAY view. \n-> Press 'n' = Switch to NIGHT view. \n-> Press 'left mouse btn' = Start RAIN. \n-> Press 'right mouse btn' = Stop RAIN.";
    glRasterPos2f(-1.5, x = x-0.1);
    for(int i = 0; c[i] !='\0'; i++) {
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, c[i]);
        if(c[i] == '\n')
...
int main(int argc, char** argv) {
    ...
    cout << "Abhishek Kameri \t\t 2HN21CS001" << endl;
    cout << "Ashish Kakade \t\t 2HN21CS007"<< endl;
    cout << "Shreyas Desai \t\t 2HN21CS040" << endl;
    cout << "Souabh Aswale \t\t 2HN21CS043" << endl;
